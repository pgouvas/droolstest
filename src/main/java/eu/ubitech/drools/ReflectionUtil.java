...
public class ReflectionUtil {
    ...
    public static Object createOrphanClazz(String label) {
        ...
        try {
            Class orhpanclass = Class.forName("eu.ubitech.drools.om.Clazz");
    ...
    public static Object createInstanceOfClazz(String label, Object clazz) {
        Object retobject = null;
        try {
            Class instanceofclass = Class.forName(
                "eu.ubitech.drools.om.InstanceOfClazz");
    ...
    public static Object createIKnowledgeTriple(Object domainioc,Object objectproperty,Object rangeioc) {
        ...
        try {
            Class instanceofclass = Class.forName(
                "eu.ubitech.drools.om.KnowledgeTriple");
            retobject = instanceofclass.getDeclaredConstructor(
                InstanceOfClazz.class, ObjectProperty.class,InstanceOfClazz.class).newInstance(domainioc, objectproperty,rangeioc);
        } catch (ClassNotFoundException | NoSuchMethodException | SecurityException | InstantiationException | IllegalAccessException | IllegalArgumentException | InvocationTargetException ex) {
            logger.log(Level.SEVERE, null, ex);
        }
        return retobject;
    ...
    public static Object createOrphanObjectProperty(String label, Object domain, Object range, boolean transitive) {
        ...
        try {
            Class instanceofclass = Class.forName(
                "eu.ubitech.drools.om.ObjectProperty");
